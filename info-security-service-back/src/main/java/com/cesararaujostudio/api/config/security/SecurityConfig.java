package com.cesararaujostudio.api.config.security;
...
public class SecurityConfig {
	...
	private static final String CLIENT_ID = "info-security-app";
	private static final String CLIENT_SECRET = "info-security-secret";
	private static final int TOKEN_VALIDITY = 0;
	private static final String SCOPE = "all";
	private static final String RESOURCE_ID = "info-security-service";
