      ...
      render={formProps => (
        <form onSubmit={formProps.submit}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={3}>
              <TextInput resource="users" source="username" validate={required()} />
            </Grid>
            <Grid item xs={3}>
            ...
            <Grid item xs={3}>
              <TextInput resource="users" source="phone" validate={required()} />
            </Grid>
            <Grid item xs={3}>
              <DateInput resource="users" source="birthdate" />
            </Grid>
            <Grid item xs={5}>
              <EnumCheckboxInput resource="users" source="roles" />
            </Grid>
            <Grid item xs={3}>
              <TextInput multiline resource="users" source="comments" />
            </Grid>
          </Grid>
          <Toolbar disableGutters>
            <Box display="flex" justifyContent="space-between" width="100%">
              ...
              {!formProps.record.deleted
                ? (<DeleteButton record={formProps.record} resource={formProps.resource} basePath={formProps.basePath} undoable={formProps.undoable} />)
                : (<RestoreButton record={formProps.record} resource={formProps.resource} basePath={formProps.basePath} />)
              }
            </Box>
          </Toolbar>
        </form>
...
export const UserCreate = props => (
  <Create undoable="false" actions={<FormActions />} {...props}>
    <SimpleForm>
      ...
      <TextInput
        multiline resource="users" source="comments" />
    </SimpleForm>
  </Create>
);
